...
The Netflix Insights Dashboard is an interactive Power BI project designed to analyze global content released on Netflix. Using the netflix_titles.csv dataset, this dashboard uncovers trends in release years, countries, genres, ratings and show types. It provides an intuitive, visual understanding of the platform’s content library and supports insights related to global entertainment consumption.
